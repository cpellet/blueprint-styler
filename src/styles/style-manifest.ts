...
import "../styles/_icrc/styler-styles.scss";
...
export const styleManifest = {
    ...
    "bpx-fluent": {
        ...
        link: "https://fluentuipr.z22.web.core.windows.net/heads/master/theming-designer/index.html",
    },
    ...
    "bpx-icrc": { label: "ICRC", link: undefined },
...
export const styleOptions: OptionProps[] = Object.entries(styleManifest).map(([styleName, config]) => ({
    label: config.label,
    value: styleName,
}));
...
export const createDarkMirrors = () => {
    ...
    getAllStyleSheets().forEach((styleSheet, i) => {
